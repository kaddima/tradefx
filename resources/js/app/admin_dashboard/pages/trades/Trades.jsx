...
const Trades = () => {
    ...
    useEffect(()=>{
        ...
        let interval = setInterval(()=>{
            ...
            assets.map((v,k)=>{
                ...
                let ch = Number(String(v.change_one_day).replace('-','')) + 5.99
  ...
  return (
    ...
    <div className='flex flex-col h-full  bg-transparent gap-1'>
        <div className="flex-1 gap-1 flex flex-col md:flex-row relative h-full">
            <div className='md:w-52 md:h-full '>
                <div className='px-2  bg-white dark:bg-secondary-dark-bg md:h-full overflow-auto'>
                    ...
                    <div className='flex flex-wrap gap-3 md:block'>
                        <div className="cursor-pointer hover:bg-gray-100 hover:dark:bg-slate-800 dark:bg-slate-700 md:dark:bg-transparent rounded-lg p-2">
                            <Link to={`/admin/user/${id}/portfolio`}>
                                <div className='flex justify-start text-gray-600 dark:text-gray-300'>
                        ...
                        <div className="cursor-pointer hover:bg-gray-100 hover:dark:bg-slate-800 relative dark:bg-slate-700 md:dark:bg-transparent rounded-lg p-2">
