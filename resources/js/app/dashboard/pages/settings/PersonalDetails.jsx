...
const PersonalDetails = () => {
  ...
  return (
    <div className='h-full text-gray-200 overflow-auto'>
        <div className='w-full flex items-center md:px-2 h-full overflow-auto'>
            <div className='flex flex-col md:flex-row rounded w-full bg-slate-100 dark:bg-slate-900 py-5'>
                <div className='md:w-2/6 flex flex-col pl-4'>
                ...
                <div className='md:w-4/6 space-y-5 text-slate-700 dark:text-slate-400 pl-4 pr-2'>
