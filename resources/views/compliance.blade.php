...
<div>
    <div class="w-4/5 md:w-3/5 mx-auto">
        <div>
            ...
            <p>At hlytopinvestments.com, we ensure we are fully transparent about our business model. We disclose all related information and inform users about charges that apply when trading with our platform.</p>
        </div>

        <div class="mt-5 space-y-4">
            <h1 class="text-xl md:text-2xl font-bold">Leveraged Trading</h1>
            <p>hlytopinvestments.com trading platform allows users to trade on leveraged funds. This means that you can trade greater amounts than you deposited, i.e. invest on margin.</p>
            <h6 class="mb-5">Example</h6>
            <p>Let’s say you’ve deposited $1,000 on your hlytopinvestments.com account. The leverage is 30:1. That means you can trade investments valued up to $30,000. The minimum account value you need to maintain in your account at all times (e.g. the margin requirement) is one thirtieth (1/30) or 2% of your investments value.</p>
            <p>Be aware that trading on margin magnifies both potential returns and potential losses. hlytopinvestments.com provides its users with an effective way to manage risk and avoid a negative account balance.</p>
        ...
        <div class="mt-5 space-y-4">
            ...
            <p>The spread is the difference between the ask price (on which you buy securities) and the bid price (on which you sell securities) of a particular CFD. When opening and closing a trade, hlytopinvestments.com users effectively pay a spread equivalent to this difference.</p>
        ...
        <div class="mt-5 space-y-4">
            ...
            <p>To start trading with hlytopinvestments.com, users first need to make a deposit. Since hlytopinvestments.com allows users to trade larger amounts than originally deposited, it means there is a funding fee involved. This funding fee, called ‘the Overnight Premium’, is only charged if a trade is left open overnight.</p>
