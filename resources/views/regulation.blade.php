...
<div>
    <div class="w-3/5 mx-auto">
        <div class="space-y-4">
            ...
            <p>Capital Com (UK) Limited is registered in England and Wales with company registration number 10506220, authorised and regulated by the Financial Conduct Authority (FCA) under register number 018839. Capital Com SV Investments Limited  is a regulated Cyprus Investment Firm, registration number HE 781146, authorised and regulated by the Cyprus Securities and Exchange Commission under the license number 319/17 (both entities referred together as “we”, “Company” or “hlytopinvestments.com”).</p>
            <p>Based in the European Union, hlytopinvestments.com complies with the requirements imposed by the Markets in Financial Instruments Directive (MiFID).</p>
        </div>

        <div class="space-y-4 mt-5">
            <h1 class="text-xl md:text-2xl font-bold">Segregated Funds</h1>
            <p>hlytopinvestments.com keeps its clients’ money in segregated bank accounts in accordance with our regulator’s rules on client money. In other words, your funds are held separately from our funds and are thus not exposed to any unexpected financial difficulties that may arise in the Company. The Company does not claim any entitlement to these funds, as they belong to you.</p>
            <p>Clients funds are spread across a number of prominent banks (Royal Bank of Scotland, Raffeissen, Eurobank, Commonwealth Bank of Australia) that are constantly reviewed to ensure they are in line with the hlytopinvestments.com guidelines.</p>
            <p>Our clients’ funds, therefore, cannot be affected by sovereign and corporate debts.</p>
            <p>Hedging is achieved through hlytopinvestments.com money only.</p>
            
        </div>

        <div class="mt-5 space-y-4">
            <h1 class="text-xl md:text-2xl font-bold">Investor Compensation warranties</h1>
             <p>hlytopinvestments.com segregates all retail client funds from its own money in accordance with relevant regulations. Capital Com (UK) Ltd is a member of the Financial Services Compensation Scheme (the “FSCS”) and Capital Com SV Investments Limited is a member of the Investor Compensation Fund (the “Fund”), which provide compensation for Retail Investors should hlytopinvestments.com declare default</p>
        ...
        <div class="mt-5 space-y-4">
            <h1 class="text-xl md:text-2xl font-bold">Fixing the amount of payable compensation </h1>
             <p>The amount of the compensation payable to each client is calculated in accordance with the legal and contractual terms governing our relationship with the client, subject to the set-off rules applied for the calculation of the claims between the client and hlytopinvestments.com. </p>
        </div>
    </div>
</div>
