...
<div class="bg-blue-50 text-center px-5 py-6">
    <div class="lg:w-3/5 mx-auto">
        ...
        <p>Tradefx provides most of its brokerage services for free. We keep our fee policy transparent. That means if we need to charge you, we will make sure these fees are clear in the beginning. Our fees are mainly based on spread charges, which are competitive across the market.</p>
...
<div class="w-11/12 lg:w-3/5 mx-auto mt-5 md:mt-10">
    ...
    <div class="mt-8 space-y-3">
        ...
        <p class="text-sm">In exchange for offering you the best trading experience, Tradefx is compensated for its services through the Buy/Sell spread. It’s simple: when you open a new position, you ‘pay’ the spread – the difference between the Buy and Sell prices.</p>
    ...
    <div class="mt-5 space-y-3">
        ...
        <p class="text-sm">We’ve been voted the Best Trading Platform and Most Innovative Broker for a reason: we cover all fees associated with deposits and withdrawals. Any fees you do incur when transferring money to and from your Tradefx account are levied by your bank or payment issuer.</p>
    ...
    <div class="mt-5 space-y-3">
        ...
        <p class="text-sm">Unlike our competitors, Tradefx charges an overnight fee that is based only on the leverage provided rather than the entire value of your position for Cryptocurrencies, Shares and Thematic Investments.</p>
        <p>The overnight fee charge on Indices, Commodities and FX is based on the entire value of your position.</p>
        <p>As the overnight fee varies across instruments, you can find the specific overnight fee for your chosen instruments in the market information panel in the Tradefx platform.</p>
    </div>
