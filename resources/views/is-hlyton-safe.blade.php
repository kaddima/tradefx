...
<div class="h-72 text-gray-200" style="background-image: url('{{asset('media/safe-backg.jpg')}}')">
    <div class="w-11/12 md:w-3/5 h-3/5 mx-auto flex justify-center items-center">
        <div>
            <h1 class="font-bold text-xl md:text-2xl mb-3 text-center">Is hlytopinvestments.com safe?</h1>
    ...
    <div class="h-2/5 flex p-5 items-center" style="background-color: rgba(0, 0, 0, 0.6)">
        <p class="md:w-3/5 text-center text-sm mx-auto">Join ,<span class="text-orange-300">500,000+</span> people, just like yourself, who’ve chosen to register with hlytopinvestments.com group for our promise to keep your funds safe.</p>
    </div>
</div>
    ...
    <div class="w-4/5 mx-auto">
        <div class="md:flex items-center">
            ...
            <div class="md:w-2/4">
                ...
                <p class="text-sm">hlytopinvestments.com has group entities authorised and regulated locally by the Financial Conduct Authority ("FCA"), the Australian Securities and Investments Commission ("ASIC"), the Cyprus Securities and Exchange Commission ("CySEC"), the NBRB and the Financial Services Authority of Seychelles (FSA).</p>
            </div>
        </div>
        ...
        <div class="md:flex items-center mt-12">
            <div class="md:w-2/4">
                <img class="w-6/12 mx-auto" src="{{asset('media/new-icon5.png')}}" alt="">
            </div>
            <div class="md:w-2/4 mt-4 md:mt-0">
                <h1 class="text-xl font-extrabold mb-4">The best data protection measures. Period.</h1>
                <p class="text-sm">hlytopinvestments.com is fully compliant with PCI Data Security Standards. This means your funds are routed through the most secure data environments. We encrypt and protect your information through Transport Layer Security, which is replicated in real time and backed up securely on a daily basis.</p>
            </div>
        </div>
    </div>
</div>
